...
if not success or not data then
	warn("Failed to load player data for character editor.")
...
titleLabel.FontFace = Font.new("rbxasset://fonts/families/AmaticSC.json")
...
genderTitle.FontFace = Font.new("rbxasset://fonts/families/AmaticSC.json")
genderTitle.Text = "SELECT GENDER"
...
maleBtn.TextSize = 24
maleBtn.FontFace = Font.new("rbxasset://fonts/families/AmaticSC.json")
maleBtn.Text = "MALE"
...
femaleBtn.TextSize = 24
femaleBtn.FontFace = Font.new("rbxasset://fonts/families/AmaticSC.json")
...
hairTitle.TextSize = 22
hairTitle.FontFace = Font.new("rbxasset://fonts/families/AmaticSC.json")
hairTitle.Text = "HAIRSTYLE"
...
randomHairBtn.TextSize = 22
randomHairBtn.FontFace = Font.new("rbxasset://fonts/families/AmaticSC.json")
randomHairBtn.Text = "RANDOM HAIR 🎲"
...
skinTitle.TextSize = 22
skinTitle.FontFace = Font.new("rbxasset://fonts/families/AmaticSC.json")
...
finishBtn.TextSize = 26
finishBtn.FontFace = Font.new("rbxasset://fonts/families/AmaticSC.json")
finishBtn.Text = "START GAME"
...
local npcsFolder = workspace:WaitForChild("NPC" .. string.char(39) .. "S", 10)
local mainFolder = npcsFolder and npcsFolder:WaitForChild("NPC" .. string.char(39) .. "S--Main", 10)
...
if starterSkin then
	camConnection = RunService.RenderStepped:Connect(function()
		...
		local lookVector = skinCF.LookVector
		-- Lock camera 7.5 studs in front of Starter_Skin facade and 4.6 studs high
		local camPosition = skinCF.Position + (lookVector * 7.5) + Vector3.new(0, 4.6, 0)
		local lookAt = skinCF.Position + Vector3.new(0, 4.0, 0)
...
finishBtn.MouseButton1Click:Connect(function()
	...
	if ok then
		...
		finishBtn.Text = "ERROR: " .. tostring(err)
		task.wait(2)
		finishBtn.Text = "START GAME"
	end
end)
